...
/usr/sbin/daemonize -c $PWD -p $PWD/acs.pid $JAVA -Xms128M -Xmx1024M -cp $PWD:$PWD/../lib/acs_server.jar:$PWD/../lib/log4j-1.2.9.jar:$PWD/../lib/classes12.jar:$PWD/../lib/xsu12.jar:$PWD/../lib/servlet-api.jar:$PWD/../lib/bcprov-jdk16-146.jar:$PWD/../lib/commons-lang-2.3.jar:$PWD/../lib/commons-httpclient-3.0.jar:$PWD/../lib/dom4j-1.5.2.jar:$PWD/../lib/jaxen-1.1-beta-9.jar:$PWD/../lib/commons-codec-1.3.jar:$PWD/../lib/commons-logging-1.0.4.jar:$PWD/../lib/json-lib-2.2-jdk15.jar:$PWD/../lib/jce.jar:$PWD/../lib/ezmorph-1.0.5.jar:$PWD/../lib/commons-collections-3.2.1.jar:$PWD/../lib/commons-beanutils.jar:$PWD/../lib/ifc.jar:$PWD/../lib/cxf-2.7.8.jar:$PWD/../lib/neethi-3.0.2.jar:$PWD/../lib/stax2-api-3.1.1.jar:$PWD/../lib/woodstox-core-asl-4.2.0.jar:$PWD/../lib/wsdl4j-1.6.3.jar:$PWD/../lib/xmlschema-core-2.0.3.jar com.interlib.ACS.ACS_Server
